    ...
    <section className="w-full py-16 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-4xl font-normal text-gray-600 mb-4" data-testid="heading-schedule">
            Season 4 Schedule
          </h2>
          <div className="text-base text-gray-600 max-w-3xl mx-auto leading-relaxed">
            <p className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-12">
          ...
          <div className="bg-white border border-red-500 p-8 flex flex-col min-h-[280px] animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            <div className="text-xl text-red-500 font-normal mb-6" data-testid="division-competitive">
            ...
            <div className="flex flex-col gap-4 mt-auto">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-700 text-white px-6 py-3 rounded-full text-sm text-center font-normal hover:bg-gray-800 transition-colors duration-300"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-gray-700 border-2 border-gray-700 px-6 py-3 rounded-full text-sm text-center font-normal hover:bg-gray-700 hover:text-white transition-all duration-300"
          ...
          <div className="bg-white border border-blue-500 p-8 flex flex-col min-h-[280px] animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            <div className="text-xl text-blue-500 font-normal mb-6" data-testid="division-intermediate">
          ...
          <div className="bg-white border border-green-500 p-8 flex flex-col min-h-[280px] animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            <div className="text-xl text-green-500 font-normal mb-6" data-testid="division-social">
              Social Division (C)
            </div>
            <div className="flex flex-col gap-4 mt-auto">
              <div className="text-xs text-gray-500 mb-1">Interactive Schedule:</div>
